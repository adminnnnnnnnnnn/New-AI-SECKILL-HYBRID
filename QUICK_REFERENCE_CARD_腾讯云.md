...
| 端口 | 服务 | 访问方式 |
|------|------|---------|
| 22 | SSH | ssh root@YOUR_SERVER_IP |
| 5173 | Vue前端 | http://YOUR_SERVER_IP:5173 |
| 8080 | API网关 | http://YOUR_SERVER_IP:8080 |
...
- **快速开�?*: [README_腾讯云部�?md](README_腾讯云部�?md)
